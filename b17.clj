...
(trg :snare smp
     ...
     :in-loop [0]
     :in-start-pos [0]
     :in-buf ["b sn0"]; (fll 32 ["b sn2" "bsn0"])
     :in-amp [1]       ; [0.15]
     )
...
(trg :uhsmp smp
     :in-trg
     (->>  (slw 8 (fll 16 ["bks2" r "boo" r "bks3" "buhea" r]) )
           (evr 5 [(rep 32 "buh")])
           ;(evr 3 [r])
           ;(evr 4 acc)
           (rpl 6 [(rep 16 "bahh")])
...
( trg :bassd smp
 ...
 (->>  [[r (rep 3 "b bd1") ]  [ "b sn1"  "b bd4"] [r r "b bd1" r] [ "b sn2" r "b bd1" r]]
       ...
       (evr 1  (sfl (fll 16 ["b bass20" r  "b sn1" r   "b bass23" r  "b sn0" r])))
